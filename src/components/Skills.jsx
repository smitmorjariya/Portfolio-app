...
const Skills = () => {
    ...
    return (
        <div id='#skills' className="bg-white min-h-screen w-full bg-gradient-to-r from-white to-gray-50 py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mb-8">
                    <div className="relative bg-gray-200 rounded-full p-1 flex gap-2 w-[336px] transition-all duration-300">
                        {/* Sliding background */}
                        <div
                        ...
                        <button
                            ...
                            className={`relative z-10 w-28 h-10 rounded-full font-semibold transition-all duration-300 ${Skill === "technical" ? "text-white" : "text-gray-700"
                                }`}
                        >
                            Technical
                        </button>
                        ...
                        <button
                            ...
                            className={`relative z-10 w-28 h-10 rounded-full font-semibold transition-all duration-300 ${Skill === "soft" ? "text-white" : "text-gray-700"
                                }`}
                        >
                            Soft Skill
                        </button>
                        ...
                        <button
                            ...
                            className={`relative z-10 w-28 h-10 rounded-full font-semibold transition-all duration-300 ${Skill === "tools" ? "text-white" : "text-gray-700"
                                }`}
                        >
                            Tools
                        </button>
